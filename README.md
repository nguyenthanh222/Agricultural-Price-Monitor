...
| Category | Tiếng Việt | Key Products |
|----------|-----------|--------------|
| **Rice** | Lúa gạo | Tấm, Hạt dài, Hạt ngắn |
| **Coffee** | Cà phê | Robusta, Arabica |
| **Vegetables & Fruits** | Rau, quả | Cà chua, Dưa, Nho, v.v. |
...
```bash
# Clone repository
git clone https://github.com/yourusername/agricultural-products-monitoring.git
cd agricultural-products-monitoring
...
### Bronze (Raw)
```
product,region,date,price
Tấm 5% Tây Ninh,Đồng bằng sông Cửu Long,13-04-2026,5200
```

### Silver (Normalized)
```
date,category,product_normalized,region,unit_normalized,price_number
2026-04-13,lua_gao,Tam 5%,Dong bang song Cuu Long,VND/tan,5200
```

### Gold (Aggregated)
```
date,category,product_normalized,region,unit_normalized,avg_price
2026-04-13,lua_gao,Tam 5%,Dong bang song Cuu Long,VND/tan,5200.0
```
